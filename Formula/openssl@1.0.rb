...
class OpensslAT10 < Formula
  ...
  def install
    ...
    args = %W[
      ...
      enable-ec_nistp_64_gcc_128b
    ]
    system "perl", "./Configure", *args
    system "make", "depend"
    system "make"
    # Regenerate certs so that they aren't expired for tests
    system "cd test/smime-certs && chmod 755 ./mksmime-certs.sh && ./mksmime-certs.sh"
    system "make", "test"
...
+"darwin64-arm64-cc","cc:-arch arm64 -DL_ENDIAN -Wall::-D_REENTRANT:MACOSX:-Wl,-search_paths_first%:SIXTY_FOUR_BIT_LONG RC4_CHUNK DES_INT DES_UNROLL:${no_asm}:dlfcn:darwin-shared:-fPIC -fno-common:-arch arm64 -dynamiclib:.\$(SHLIB_MAJOR).\$(SHLIB_MINOR).dylib",
...
--- openssl-1.0.2u/test/smime-certs/mksmime-certs.sh.orig	2023-06-26 17:47:09
+++ openssl-1.0.2u/test/smime-certs/mksmime-certs.sh	2023-06-26 17:45:27
@@ -2,7 +2,7 @@
